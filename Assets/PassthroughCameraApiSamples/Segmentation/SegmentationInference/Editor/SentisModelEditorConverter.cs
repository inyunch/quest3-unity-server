...
namespace PassthroughCameraSamples.Segmentation.Editor
{
    ...
    [CustomEditor(typeof(SegmentationInferenceRunManager))]
    public class SentisModelEditorConverter : UnityEditor.Editor
    {
        ...
        private SegmentationInferenceRunManager m_targetClass;
        private float m_iouThreshold;
        private float m_scoreThreshold;

        public void OnEnable()
        {
            m_targetClass = (SegmentationInferenceRunManager)target;
